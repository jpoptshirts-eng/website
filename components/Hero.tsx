    ...
    >
      ...
      <div className="mx-auto max-w-page px-6 lg:px-8">
        <div className="relative lg:grid lg:grid-cols-12 lg:items-start lg:gap-x-4 xl:gap-x-6">
          ...
          <div
            id="about"
            className="order-1 scroll-mt-24 lg:col-span-7 lg:col-start-1 lg:row-start-1 lg:z-30"
          >
            <motion.p
              custom={0}
              variants={fadeUp}
            ...
            <motion.h1
              ...
              initial="hidden"
              animate="visible"
              className="relative z-30 text-[2.35rem] font-black leading-[0.92] tracking-[-0.03em] sm:text-5xl md:text-6xl lg:max-w-none lg:text-[4rem] lg:leading-[0.92] xl:text-[4.75rem] lg:-mr-[10%] xl:-mr-[8%]"
            >
          ...
          <div className="order-2 mt-10 lg:order-none lg:col-span-4 lg:col-start-7 lg:row-start-1 lg:mt-0 lg:z-10 xl:col-span-4 xl:col-start-7">
            <div className="relative mx-auto w-full max-w-sm md:max-w-md lg:max-w-none lg:pr-4">
              ...
              >
                {heroError ? (
                  <div
                    className="relative mx-auto aspect-[3/4] w-full max-w-md lg:max-w-none"
                    aria-hidden
                  >
                    <span className="absolute inset-0 flex items-center justify-center text-sm text-grey">
                      Portrait
                    </span>
                  </div>
                ) : (
          ...
          {/* Side note + scroll — own column, clear of the portrait */}
          <motion.aside
            custom={0.45}
            variants={fadeUp}
            initial="hidden"
            animate="visible"
            className="relative z-20 order-3 mt-10 hidden flex-col lg:col-span-2 lg:col-start-11 lg:row-start-1 lg:mt-8 lg:flex xl:mt-12"
          >
